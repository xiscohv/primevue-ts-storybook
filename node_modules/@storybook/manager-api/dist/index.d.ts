...
import { API_IframeRenderer, Addon_Types, Addon_TypesEnum, Addon_Collection, Addon_TypesMapping, API_Panels, API_StateMerger, API_Provider, API_Notification, StoryId, API_Settings, API_LoadedRefData, API_ViewMode, API_StatusState, API_HashEntry, API_LeafEntry, API_PreparedStoryIndex, API_StoryEntry, Args, API_IndexHash, API_ComposedRef, API_StatusUpdate, API_DocsEntry, API_Refs, API_SetRefData, API_ComposedRefUpdate, API_Layout, API_UI, API_PanelPositions, API_Versions, API_UnknownEntries, API_Version, Globals, GlobalTypes, Addon_BaseType, Addon_PageType, Addon_WrapperType, Addon_Config, API_ProviderData, API_OptionsData, Parameters, ArgTypes } from '@storybook/types';
...
interface SubAPI$b {
     ...
     */
    getElements: <T extends Addon_Types | Addon_TypesEnum.experimental_PAGE = Addon_Types>(type: T) => Addon_Collection<Addon_TypesMapping[T]>;
    /**
...
declare class AddonStore {
    ...
    getElements<T extends Addon_Types | Addon_TypesEnum.experimental_PAGE>(type: T): Addon_Collection<Addon_TypesMapping[T]>;
    /**
     ...
     * @returns {void}
     */
    add(id: string, addon: Addon_BaseType | (Omit<Addon_PageType, 'id'> & DeprecatedAddonWithId) | (Omit<Addon_WrapperType, 'id'> & DeprecatedAddonWithId)): void;
